...
from dhWindow import Ui_MainWindow


class Ui_jointWindow(object):
    def openWindow(self):
        joint=self.textEdit.toPlainText()
        if(joint!=''):
            self.window=QtWidgets.QMainWindow()
            self.ui=Ui_MainWindow(len(joint))
    ...
    def enterJoint(self,jointName):
        self.joint=self.textEdit.toPlainText()
        if(jointName=="R"):
            self.textEdit.setText(self.joint+'R')
        else :
            self.textEdit.setText(self.joint+'P')
